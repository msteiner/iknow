...
public class TextTest {
  ...
  public void testClone() {
    ...
    Assert.assertTrue("Expected " + TEXT_GREEN + " but found " + clone.getText(), 
                      TEXT_GREEN == clone.getText());
    ...
    Assert.assertTrue("Expected 0 synapsesId but found " + clone.getSynapseIds().size(),
                     0 == clone.getSynapseIds().size());
